...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      <div class="page-header d-flex align-items-center" style="background-image: url('assets/img/bg-locater.jpg');">
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <img src="./assets/img/locater.png" alt="" style="max-width:100%;height: auto">
              <h2 style="color:#10237f; font-size: 25px;">REACH US</h2>
              <p style="font-family: 'Buenard-Regular';font-size: 18px;color: #000">We're always there to help</p>
            </div>
          </div>
        </div>
      </div>
