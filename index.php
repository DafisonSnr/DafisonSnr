      ...
      <div class="container" data-aos="fade-up">
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>About Us</h3>
            <p>
              Our story began in 1990 as a small courier delivery service and Security company with big ambitions and 
              bigger dreams. Our vision was not just to build a business, but to build enduring and close ties with our 
              customers, while offering them a broad range of services. 25 years later, and over 10,000 locations across the globe, 
              Steel Safe Security Company Express Limited has grown from a miniature outfit to a multinational logistics/Security company. 
              As strategic partners of DPD, owned by the international brand GeoPost, our story has reached a new chapter as United Kingdom 
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <p> The biggest strength of Steel Safe Security Company is its unique network & partner-based business model. 
              Our organisation has one of the fastest-growing franchise business networks across the globe. We have developed 
              the largest chain of express courier and security services in United Kingdom and have replicated the same model in 
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-7 order-2 order-md-1">
            ...
            <p class="fst-italic">
              Create a free account and enjoy discounts on shipping, easy access to saved delivery addresses, 
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-7">
            ...
            <p>Sign up for STEEL Delivery Manager® to place holds, give delivery instructions, sign remotely, and more. 
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  ...
                  Steel Safe Security Company Fulfilment Service for sellers has given me the edge to upgrade my business. I can now work on my core competency which is to source goods. 
                  The FC has world class facilities and products go through a series of Quality check. They nicely pack my items and have a very short processing time, which is delighting my customers. Thanks.
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  Thank you very much for safe delivery. My daughter is very happy for the gift. Very good service.
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
